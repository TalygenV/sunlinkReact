...
import { ChevronLeft, Expand, X, Shield, Check, Calculator, CreditCard, Lock } from 'lucide-react';

const SolarCustomization = () => {
    const [batteryCount, setBatteryCount] = useState(1);
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [selectedPlan, setSelectedPlan] = useState('15-years');

    type ToggleKey = 'solarLayout' | 'totalCost' | 'evCharger' | 'roofReplacement' | 'electricalPanel';
    ...
    const incrementBattery = () => setBatteryCount(prev => Math.min(prev + 1, 5));
    const decrementBattery = () => setBatteryCount(prev => Math.max(prev - 1, 1));
            ...
            <div className="max-w-[1440px] mx-auto w-full px-6 lg:px-8 relative">
                ...
                <div className="flex items-center gap-4 mb-10 text-sm font-medium flex-wrap">
                    ...
                    <div className="flex items-center gap-2 text-white">
                        <div className="w-6 h-6 rounded-full bg-amber-800 text-white text-xs font-bold flex items-center justify-center">2</div>
                        <span>Batteries</span>
                    </div>
                    ...
                    {/* Step 3 */}
                    <div className="flex items-center gap-2 text-white">
                        <div className="w-6 h-6 rounded-full bg-amber-800 text-white text-xs font-bold flex items-center justify-center">3</div>
                    ...
                    {/* Step 4 */}
                    <div className="flex items-center gap-2 text-white">
                        <div className="w-6 h-6 rounded-full bg-amber-800 text-white text-xs font-bold flex items-center justify-center">4</div>
                    ...
                    <div className="w-full space-y-4">
                        ...
                        <div className="w-full rounded-xl relative p-6 text-white border border-neutral-600">
                            ...
                            <div className="bg-slate-800 text-white p-5 rounded-xl shadow-lg w-full">
                                ...
                                <div className="flex justify-between mb-4">
                                    ...
                                    <div className="text-gray-300 flex items-center">
                                        <span className="mr-2 text-sm text-gray-300">Solar Layout</span>
                                        ...
                                        <span className="ml-2 text-sm text-gray-300">Savings Chart</span>
                                    </div>
                                </div>
                                ...
                                <div className="bg-neutral-800 p-3 rounded-2xl border-0 mt-5 text-left text-white text-sm font-normal flex items-start">
                                    ...
                                    Disclaimer: Final layout may change based on city, utility, roof conditions, and code. SunLink Verified Installers will optimize it for performance, aesthetics, and compliance.
                                </div>
                            </div>
                            ...
                            <div className="bg-slate-800 text-white p-5 rounded-xl shadow-lg w-full mt-4">
                                <div className="flex mb-4">
                                    <p className="text-sm text-gray-300 flex items-center border rounded-xl px-3 py-1">
                                        <span className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2"></span> Step 2
                                    </p>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-x-6 gap-y-4 mt-3 w-full">
                                    <div className="w-full sm:w-[calc(50%-0.75rem)]">
                                        <div className="grid grid-cols-2 w-full gap-4">
                                            ...
                                            <div className="bg-slate-700 text-white rounded-xl p-4 border border-neutral-600">
                                                ...
                                                <div className="flex justify-between items-center">
                                                    <span className="text-xs text-gray-400">12.8kW System</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="bg-slate-700 text-white rounded-xl p-4 border border-neutral-600">
                                                <div className="flex justify-between items-center">
                                                    <span className="text-xs text-gray-400">Battery Storage</span>
                                                </div>
                                                ...
                                                <div className="flex justify-between items-center">
                                                    <span className="text-xs text-gray-400">-8 hours backup</span>
                                                </div>
                                            </div>

                                            {/* Solar System Cost */}
                                            <div className="bg-emerald-900 text-white rounded-xl p-4 border border-neutral-600">
                                                <div className="text-xs text-gray-400">Solar System Costs ($)</div>
                                                <div className="text-4xl pt-6">22,400</div>
                                            </div>

                                            {/* Battery Cost */}
                                            <div className="bg-emerald-900 text-white rounded-xl p-4 border border-neutral-600">
                                                <div className="text-xs text-gray-400">Battery Cost ($)</div>
                                                <div className="text-4xl pt-6">{(batteryCount * 15000).toLocaleString()}</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-orange-900 text-white rounded-xl p-4 border border-neutral-600 w-full sm:w-[calc(50%-0.75rem)]">
                                        <div className="flex justify-between items-center">
                                            <span className="text-xs text-gray-400">Total System Cost ($)</span>
                                            <label className="inline-flex items-center cursor-pointer">
                                                <input
                                                    type="checkbox"
                                        ...
                                        <div className="text-4xl pt-32">{totalCost.toLocaleString()}</div>
                                        <div className="flex justify-between items-center">
                                            <span className="text-xs text-gray-400">Before Incentives</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="bg-slate-700 p-3 rounded-md flex justify-between mb-5">
                                        <div className="flex w-full">
                                            ...
                                            <div className="w-full">
                                                ...
                                                <p className="text-sm text-gray-300">Generate custom quote</p>
                                            </div>
                                        </div>
                                        <div>
                                            <label className="inline-flex items-center cursor-pointer">
                                        ...
                                        <div className="flex w-full">
                                            ...
                                            <div className="w-full">
                                                <p className="text-gray-300 flex items-center">
                                                    Electrical Panel Upgrade
                                                    <span className="ml-1 text-xs bg-blue-500 text-white rounded-full w-4 h-4 flex items-center justify-center">i</span>
                                                </p>
                                ...
                                <div className="bg-neutral-800 p-3 rounded-2xl border-0 mt-5 text-left text-white text-sm font-normal flex items-start">
                                    ...
                                    Tax Credit Disclaimer: The 30% federal tax credit is subject to eligibility requirements and may vary based on your tax situation. Consult with a tax professional to determine your specific benefits. Local and utility incentives vary by location and may have additional requirements or limitations.
                                </div>
                                ...
                                <div className="bg-red-900 p-3 rounded-2xl border-0 mt-5 text-left text-white text-sm font-normal flex items-start">
                                    ...
                                    Act fast - the 30% federal solar tax credit expires at the end of 2025, and you must be fully signed up and have your system installed before year-end to claim this significant savings.
                                </div>
                                        ...
                                        <div className="bg-slate-700 p-3 rounded-md flex justify-between">
                                            <div className="flex w-full">
                                                ...
                                                <div className="w-full">
                                                    ...
                                                    <p className="text-sm text-gray-300">Complete coverage for solar panels against manufacturing defects.</p>
                                                </div>
                                            </div>
                                            <div className="w-24">
                                                <p className="text-sm text-gray-300 border rounded-xl px-2 py-1">25 years</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-slate-700 p-3 rounded-md flex justify-between">
                                            <div className="flex w-full">
                                                ...
                                                <div className="w-full">
                                                    ...
                                                    <p className="text-sm text-gray-300">Guaranteed 80% power output after 25 years of operation.</p>
                                                </div>
                                            </div>
                                            <div className="w-24">
                                                <p className="text-sm text-gray-300 border rounded-xl px-2 py-1">25 years</p>
                                        ...
                                        <div className="bg-slate-700 p-3 rounded-md flex justify-between">
                                            <div className="flex w-full">
                                                ...
                                                <div className="w-full">
                                                    ...
                                                    <p className="text-sm text-gray-300">Comprehensive workmanship guarantee on all installation work.</p>
                                                </div>
                                            </div>
                                            <div className="w-24">
                                                <p className="text-sm text-gray-300 border rounded-xl px-2 py-1">10 years</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-slate-700 p-3 rounded-md flex justify-between">
                                            <div className="flex w-full">
                                                ...
                                                <div className="w-full">
                                                    ...
                                                    <p className="text-sm text-gray-300">Tesla Powerwall warranty with 70% capacity retention guarantee.</p>
                                                </div>
                                            </div>
                                            <div className="w-24">
                                                <p className="text-sm text-gray-300 border rounded-xl px-2 py-1">10 years</p>
                            ...
                            <div className="bg-slate-800 text-white p-5 rounded-xl shadow-lg w-full mt-4">
                                <div className="flex mb-4">
                                    <p className="text-sm text-gray-300 flex items-center border rounded-xl px-3 py-1">
                                        <span className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2"></span> Step 3
                                    </p>
                                </div>

                                <div className="text-gray-300 mb-2 text-lg">Choose your payment plan</div>
                                <div className="text-gray-100 text-base mb-4">Select the financing option that works best for you</div>
                                ...
                                <div className="bg-neutral-800 p-3 rounded-2xl border-0 mt-5">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 w-full gap-4">
                                        ...
                                        <div className="bg-slate-600 p-3 rounded-xl">
                                            <div className="flex mb-4">
                                                <p className="text-sm text-gray-300 flex items-center border rounded-xl px-3 py-1">
                                                    <span className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2"></span> 1
                                                </p>
                                            </div>
                                            <div className="w-full text-white text-sm font-normal mb-2">Months 1-16: Lowest Payment</div>
                                            <div className="w-full text-gray-300 text-xs font-normal">Your monthly payment remains fixed during the first 16 months. During this period, you can apply your tax credit or make an optional lump sum payment. This reduces your total loan amount and adjusts your monthly payment after month 16.</div>
                                        </div>
                                        ...
                                        <div className="bg-slate-600 p-3 rounded-xl">
                                            <div className="flex mb-4">
                                                <p className="text-sm text-gray-300 flex items-center border rounded-xl px-3 py-1">
                                                    <span className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2"></span> 2
                                                </p>
                                            </div>
                                            <div className="w-full text-white text-sm font-normal mb-2">Months 16: Tax Credit Decision</div>
                                            <div className="w-full text-gray-300 text-xs font-normal">If eligible, you may claim the 30% federal solar tax credit. At this stage, you can choose to apply any received benefit toward your loan or keep it for other financial planning. (Consult your tax advisor for eligibility and timing.)</div>
                                        </div>
                                        ...
                                        <div className="bg-slate-600 p-3 rounded-xl">
                                            <div className="flex mb-4">
                                                <p className="text-sm text-gray-300 flex items-center border rounded-xl px-3 py-1">
                                                    <span className="w-1.5 h-1.5 bg-orange-400 rounded-full mr-2"></span> 3
                                                </p>
                                            </div>
                                            <div className="w-full text-white text-sm font-normal mb-2">Months 17+: Payment Adjusts</div>
                                            <div className="w-full text-gray-300 text-xs font-normal">Your monthly payment updates based on the total loan amount owed after you apply your tax credit, personal funds, or both. The more you apply, the lower your balance and monthly payment.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-neutral-900 p-3 rounded-2xl border-0 mt-5 text-left text-white text-sm font-normal flex items-start">
                                        ...
                                        Industry Standard Structure: This re-amortizing structure is the standard for solar financing and is designed to work with the federal tax credit timeline, giving you maximum flexibility in how to use your tax savings.
                                    </div>
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div className="bg-white relative rounded-2xl shadow-lg px-4 pt-8 pb-4">
                                            ...
                                            <div className="flex items-center space-x-3 mb-4">
                                                ...
                                                <div>
                                                    <div className="text-sm text-black font-medium">10 Years</div>
                                            ...
                                            <div className="bg-gray-100 rounded-xl p-3 my-4 text-center">
                                                ...
                                                <p className="text-2xl font-medium text-gray-800">$189/mo</p>
                                                ...
                                                <div className="mt-4 text-xs">
                                                    <div className="flex justify-between">
                                                        ...
                                                        <p className="text-green-600">$425/mo</p>
                                                    </div>
                                                    <div className="flex justify-between">
                                                        <p className="text-gray-600">After tax credit</p>
                                                        <p className="text-green-600 opacity-75">$295/mo</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <button
                                                onClick={() => setSelectedPlan('10-years')}
                                                className={`w-full mt-4 py-2 rounded-lg text-xs flex items-center justify-center space-x-2 ${selectedPlan === '10-years'
                                        ...
                                        <div className="bg-white relative rounded-2xl shadow-lg px-4 pt-8 pb-4">
                                            ...
                                            <div className="flex items-center space-x-3 mb-4">
                                                ...
                                                <div>
                                                    <div className="text-sm text-black font-medium">15 Years</div>
                                                    <div className="text-xs text-gray-500">4.49% APR</div>
                                                </div>
                                            </div>
                                            ...
                                            <button
                                                ...
                                                className={`w-full mt-4 py-2 rounded-lg text-xs flex items-center justify-center space-x-2 ${selectedPlan === '15-years'
                                                        ? 'bg-blue-600 text-white'
                                                        : 'bg-gray-800 text-white hover:bg-gray-700'
                                                    }`}
                                            >
                                        ...
                                        <div className="bg-white relative rounded-2xl shadow-lg px-4 pt-8 pb-4">
                                            ...
                                            <div className="flex items-center space-x-3 mb-4">
                                                ...
                                                <div>
                                                    <div className="text-sm text-black font-medium">25 Years</div>
                                                    <div className="text-xs text-gray-500">4.49% APR</div>
                                                </div>
                                            </div>
                                            ...
                                            <button
                                                ...
                                                className={`w-full mt-4 py-2 rounded-lg text-xs flex items-center justify-center space-x-2 ${selectedPlan === '25-years'
                                                        ? 'bg-blue-600 text-white'
                                                        : 'bg-gray-800 text-white hover:bg-gray-700'
                                                    }`}
                                            >
                                        ...
                                        <div className="flex flex-col justify-center">
                                            <div className="flex justify-between space-x-3 mb-6">
                                                <div className="text-center">
                                                    <p className="text-2xl text-gray-900 font-bold">$19,950</p>
                        ...
                        <div className="w-full rounded-xl relative p-6 text-white border border-neutral-600">
                                ...
                                <div className="bg-white p-3 rounded-xl text-left">
                                    <div className="flex mb-4">
                                        <p className="text-sm bg-orange-100 text-orange-600 flex items-center border rounded-xl px-3 py-1">
                                            <span className="w-1.5 h-1.5 bg-orange-600 rounded-full mr-2"></span> 1
                                        </p>
                                    </div>
                                    <div className="w-full text-black text-sm font-normal mb-2">Confirm Order</div>
                                    <div className="w-full text-gray-500 text-xs font-normal">Submit your $500 deposit to secure your system and lock in current price.</div>
                                </div>

                                <div className="bg-white p-3 rounded-xl text-left">
                                    <div className="flex mb-4">
                                        <p className="text-sm bg-orange-100 text-orange-600 flex items-center border rounded-xl px-3 py-1">
                                            <span className="w-1.5 h-1.5 bg-orange-600 rounded-full mr-2"></span> 2
                                        </p>
                                    </div>
                                    <div className="w-full text-black text-sm font-normal mb-2">Upload Photos</div>
                                    <div className="w-full text-gray-500 text-xs font-normal">Share photos of your home for system design.</div>
                                </div>

                                <div className="bg-white p-3 rounded-xl text-left">
                                    <div className="flex mb-4">
                                        <p className="text-sm bg-orange-100 text-orange-600 flex items-center border rounded-xl px-3 py-1">
                                            <span className="w-1.5 h-1.5 bg-orange-600 rounded-full mr-2"></span> 3
                                        </p>
                                    </div>
                                    <div className="w-full text-black text-sm font-normal mb-2">Get Professional Installer</div>
                                    <div className="w-full text-gray-500 text-xs font-normal">Connect with certified installers in your area.</div>
                                </div>
                            </div>
                            ...
                            <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-5">
                                <div className="flex items-center mb-4">
                                    ...
                                    <p className="text-base font-medium">What is a SunLink Verified Installer?</p>
                                </div>
                                ...
                                {(toggleStates.evCharger || toggleStates.electricalPanel) && (
                                    <div className="flex justify-between mb-4">
                                        ...
                                        <p className="text-gray-300">
                                            ${((toggleStates.evCharger ? 2500 : 0) + (toggleStates.electricalPanel ? 3500 : 0)).toLocaleString()}
                                        </p>
                                    </div>
                                )}
                            </div>
