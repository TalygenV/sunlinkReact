...
//                 {/* Close Button */}
//                 <button onClick={onClose} className="absolute top-4 right-4 bg-gray-800 text-white p-2 rounded-full hover:bg-gray-700 z-10"> <X size={20} />
//                 </button>
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-80 flex items-center justify-center">
            <div className="relative w-full max-w-6xl h-[90vh] bg-black rounded-lg shadow-lg overflow-hidden">
                ...
                {/* Optional scale slider UI */}
                {/* <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/60 text-white px-4 py-2 rounded shadow-lg flex items-center space-x-2">
          <label htmlFor="scaleSlider" className="text-sm">Model Size</label>
          <input
            id="scaleSlider"
            type="range"
            min="0.5"
